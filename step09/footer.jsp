				...
				<div class="row section_gap">
					...
					<div class="offset-lg-1 col-lg-2 col-md-6 col-sm-6">
						<div class="single-footer-widget tp_widgets">
							...
							<ul class="list">
								<li><a href="<c:url value="/step09/index.jsp"/>">Home</a></li>
								<li><a href="<c:url value="/step09/products.jsp"/>">Shop</a></li>
								<li><a href="<c:url value="/BoardListAction?pageNum=1"/>">Blog</a></li>
								<li><a href="<c:url value="/step09/products.jsp"/>">Product</a></li>
