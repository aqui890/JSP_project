        ...
        <div class="row no-gutters align-items-center pt-60px">
          ...
          <div class="col-sm-7 col-lg-6 offset-lg-1 pl-4 pl-md-5 pl-lg-0">
            <div class="hero-banner__content">
              ...
              <a class="button button-hero" href="<c:url value="/step09/products.jsp"/>">Browse Now</a>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row">
          <div class="col-xl-5">
            <div class="offer__content text-center">
              ...
              <a class="button button--active mt-3 mt-xl-4" href="<c:url value="/step09/products.jsp"/>">Shop Now</a>
            </div>
          </div>
        </div>
      </div>
